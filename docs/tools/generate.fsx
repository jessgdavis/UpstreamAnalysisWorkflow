...
let website = "/UpstreamAnalysisWorkflow"

let githubLink = "https://github.com/jessicagrace17/UpstreamAnalysisWorkflow/jessicagrace17/UpstreamAnalysisWorkflow"

// Specify more information about your project
let info =
  [ "project-name", "UpstreamAnalysisWorkflow"
    "project-author", "Jessica Davis"
    "project-summary", "A project to simplify the process of preparing a set of genes for upstream analysis. Uses the Bi-directional best hit method to identify homologous genes and finds their upstream regions. Makes use of the Experimental-dotnetbioGenBankProvider."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/UpstreamAnalysisWorkflow" ]
